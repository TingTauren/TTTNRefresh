...
#import "TTTNRefreshAutoStateHeader.h"

@interface TTTNRefreshAutoStateHeader()
/** 显示刷新状态的label */
...
@implementation TTTNRefreshAutoStateHeader
...
- (void)stateLabelClick {
    if (self.state == TTTNRefreshStateIdle) {
