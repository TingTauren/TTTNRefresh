...
#import "TTTNRefreshBackGifFooter.h"

@interface TTTNRefreshBackGifFooter()
/** Gif视图 */
...
@implementation TTTNRefreshBackGifFooter
...
- (void)setState:(TTTNRefreshState)state {
    ...
    else if (state == TTTNRefreshStateNoMoreData) {
...
- (void)tttn_placeSubviewsFrame {
    ...
    if (self.stateLabel.hidden) {
        ...
        if (self.tttn_direction == TTTNRefreshScrollDirectionHorizontal) {
            ...
            self.gifView.tttn_h = self.tttn_h * 0.5 - stateSize * 0.5 - self.labelLeftInset;
        }
        else {
            self.gifView.contentMode = UIViewContentModeRight;
            self.gifView.tttn_w = self.tttn_w * 0.5 - stateSize * 0.5 - self.labelLeftInset;
        }
    }
}
